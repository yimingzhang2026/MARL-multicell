...
def get_config():
    ...
    Network parameters:
        ...
        --use_shared_V
            by default True, use shared info during training or else will not use info from neighbors.
        --stacked_frames <int>
    ...
    parser.add_argument("--seed", type=int, default=2023, help="Random seed for numpy/torch")
    ...
    parser.add_argument("--use_shared_V", action='store_false',
                        default=True, help="Whether to use shared information from neighbors to estimate V function")
    ...
    parser.add_argument("--opti_eps", type=float, default=5e-6,
