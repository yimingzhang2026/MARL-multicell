...
class EnvCore(object):
    ...
    def __init__(self,args):
        ...
        #print(self.max_deg)
        self.obs_dim = (self.max_num_neighbors + 1) *  self.num_devices
        self.action_dim = 1 + self.num_devices
    ...
    def step(self, actions):
        ...
        sub_agent_info = []
        allocated_spectrum = self.actions2allocation(actions, self.M)
    ...
    def get_state_traffic(self):
        ...
        """
        local_state_dim = (self.max_num_neighbors + 1) * self.num_devices
        ...
        for ap in range(actions.shape[0]):
            ...
            for subband_index, subband_decision in enumerate(subband_decisions):
                ...
                if action == 0: #indicate that no link is selected on this subbad
                    ...
                    allocation[self.local_to_global[(scheduled_link_local_index,ap)],subband_index] = 1 # activate the scheduled link
        return allocation
