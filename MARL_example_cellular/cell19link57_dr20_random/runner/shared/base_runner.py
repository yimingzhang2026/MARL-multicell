...
class Runner(object):
    ...
    def __init__(self, config):
        ...
        self.use_shared_V = self.all_args.use_shared_V
        ...
        share_observation_space = self.envs.share_observation_space[0] if self.use_shared_V else self.envs.observation_space[0]
